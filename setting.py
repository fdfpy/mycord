...
CSV_DB_PATH_COLUMNS = ('STOCK_NUM', 'COM_NAME', 'URL', 'SIGMA', 'EXPECTATION', 'KESSAN', 'OTOTOI', 'YESTERDAY', 'TODAY', 'PER',
        'LASTYEAR_PROFIT_PER_STOCK', 'THISYEAR_PROFIT_PER_STOCK', 'KESSAN_MONTH', 'PERMAX', 'PERMIN','KAIRIMIN','KAIRIMAX','KAIRI_RANK')
